...
extension ___FILEBASENAMEASIDENTIFIER___Presenter {
    ...
    typealias CustomViewControllerType       = ___FILEBASENAMEASIDENTIFIER___TableViewController
...
extension ___FILEBASENAMEASIDENTIFIER___Wireframe {
    ...
    typealias CustomViewInterfaceType         = ___FILEBASENAMEASIDENTIFIER___TableViewController
